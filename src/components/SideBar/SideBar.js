...
class SideBar extends Component {
    ...
    render() {
        return (
            <nav id="side-bar" className={this.props.openSideBar ? 'open':''}>
                <span id="close-nav" onClick={() => {this.props.toggleSideBarCover()}}><i className="fa fa-close"></i></span>
                <div id="logo-wrapper">
                    <div>
                ...
                <ul id="menu-options-wrapper">
                    <li>
                        <Link className={this.setActive(this.props.location.pathname, '/')} to='/'>
                            About
                        </Link>
                    </li>
                    <li>
                        <Link className={this.setActive(this.props.location.pathname, '/articles')}  to='/articles'>
                            Articles
                        </Link>
                    </li>
                    <li>
                        <Link className={this.setActive(this.props.location.pathname, '/my-articles')}  to='/my-articles'>
                            My Articles
                        </Link>
                    </li>
                </ul>
